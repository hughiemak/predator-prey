...
Environment description: A toroidal grid world in which 4 predators (blue agents) learn to capture a randomly moving prey (red) for a shared reward of 100 in 100 time steps.
